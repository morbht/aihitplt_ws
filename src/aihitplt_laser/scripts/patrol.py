...
from aihitplt_laser.cfg import PatrolParamConfig
...
class AgvPatrol():
    def __init__(self):
        ...
        self.dyn_client = dynamic_reconfigure.client.Client("AgvPatrol", timeout=60)
    ...
    def registerScan(self, scan_data):
        ...
        for i in range(len(ranges)):
            angle = (scan_data.angle_min + scan_data.angle_increment * i) * RAD2DEG*2
...
if __name__ == '__main__':
    rospy.init_node('AgvPatrol', anonymous=False)
    patrol = AgvPatrol()
    patrol.process()
    rospy.spin()
