...
class PanTiltSensorNode:
    ...
    def __init__(self):
        rospy.init_node('muti_ai_sensor', anonymous=True)
        ...
        self.pub_all = rospy.Publisher('/muti_ai/sensor_data', String, queue_size=10)
    ...
    def _load_config_from_yaml(self):
        ...
        if not os.path.exists(config_file):
            config_file = '/home/aihit/aihitplt_ws/src/aihitplt_hardware_test/config/muti_ai_port.yaml'
