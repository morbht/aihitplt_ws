...
int main(int argc, char *argv[])
{
	...
	ndHandle.param("source_path", source_path, std::string("/home/aihit/aihitplt_ws/src/xf_mic_asr_offline_circle"));
	ndHandle.param("/appid", appid, std::string("0daad079"));//appid，需要更换为自己的
