...
//     struStartTime.dwMonth	= 6;
      ...
      //  struStartTime.dwHour	= 0;
       ...
       m_struFileCondV50.dwFileType = 0xff;
            ...
            m_struFileCondV50.struStartTime.wYear = 2021;
            m_struFileCondV50.struStartTime.byMonth = 4;
            m_struFileCondV50.struStartTime.byDay = 30;
            m_struFileCondV50.struStartTime.byHour = 14;
            m_struFileCondV50.struStartTime.byMinute = 1;
            m_struFileCondV50.struStartTime.bySecond = 0;
            m_struFileCondV50.struStopTime.wYear = 2021;
            m_struFileCondV50.struStopTime.byMonth = 4;
            m_struFileCondV50.struStopTime.byDay = 30;
            m_struFileCondV50.struStopTime.byHour = 14;
            m_struFileCondV50.struStopTime.byMinute = 2;
            m_struFileCondV50.struStopTime.bySecond = 0;
...
int Demo_PlayBackByTime(LONG lUserID)
{
	int hPlayback;
        ...
        struVodPara.struBeginTime.dwYear = 2021;
        struVodPara.struBeginTime.dwMonth = 4;
        struVodPara.struBeginTime.dwDay = 30;
        struVodPara.struBeginTime.dwHour = 13;
        struVodPara.struBeginTime.dwMinute = 49;
        struVodPara.struBeginTime.dwSecond = 0;
        struVodPara.struEndTime.dwYear = 2021;
        struVodPara.struEndTime.dwMonth = 4;
        struVodPara.struEndTime.dwDay = 30;
        struVodPara.struEndTime.dwHour = 13;
        struVodPara.struEndTime.dwMinute = 50;
