...
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 39f1fbeb, work_dir = /home/sim/aihitplt_ws/src/aihitplt_voice_system/bin";//登录参数,appid与msc库绑定,请勿随意改动
	/*
	* rdn:           合成音频数字发音方式
	* volume:        合成音频的音量
	* pitch:         合成音频的音调
	...
	*/
	...
	/* 文本合成 */
	printf("请输入文本，按下回车键开始合成 ...\n");
        char str1[20000];
        scanf("%s",str1);
        text = str1;
        printf("请输入合成音频的文件名，按下回车键确定 ...\n");
        char str2[200];
        scanf("%s",str2);
        filename = str2;
