...
class Color_Identify:
    ...
    def process(self, rgb_img):
        ...
        if command_result == 73 :
            ...
            print("tracker red")
            self.hsv_range =  [(0, 185, 158), (184, 253, 255)]
        elif command_result == 74 :
            self.model = "color_follow_line"
            print("tracker green")
            self.hsv_range =  [(54, 113, 64), (75, 255, 255)]
        elif command_result == 75 :
            self.model = "color_follow_line"   
            print("tracker bule")
            self.hsv_range =  [(102, 150, 124), (124, 253, 255)] 
        elif command_result == 72 :
            self.model = "color_follow_line"
            print("tracker yellow")
            self.hsv_range =  [(19, 57, 180), (125, 253, 255)]
        elif command_result == 22 :
            self.model = "Stop"
            self.ros_ctrl.Joy_active == False
